          ...
          resp.data.forEach((el) => {
            item += `<tr><th scope='row'>${el.id}</th>
                        ...
                        <td> <div class="btn-group" role="group">
                          ...
                          <button type="button" class="btn btn-success fa fa-file-medical s_animal" title='Agregar Vacunacion' data-id='${el.id}'></button>
                          <button type="button" class="btn btn-secondary fa-sharp-duotone fa-solid fa-syringe m_animal" title= 'Historial Médico Animal' data-id='${el.id}'></button>
