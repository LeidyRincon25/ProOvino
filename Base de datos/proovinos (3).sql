...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-09-2024 a las 02:10:46
...
(3, 'oxisol', 'Locion '),
(4, 'Algivet', 'Frasco-Ampolla'),
(5, 'penovet', 'Polvo para suspensión oral '),
(6, 'Ivomec', 'Solución Oral'),
(7, 'oxisol', 'inyectable'),
(8, 'oxisol', 'tabletas');
...
--
-- Volcado de datos para la tabla `tbmortalidad`
--

INSERT INTO `tbmortalidad` (`IdMortalidad`, `MortaFecha`, `MortaCausa`, `IdRegOvino`) VALUES
(1, '2024-08-01', 'Problemas al Respirar', 3),
(2, '2024-08-29', 'Parasitos', 5),
(3, '2024-08-09', 'Sarna', 1),
(4, '2024-09-05', 'Fiebre Aftosa', 8),
(5, '2024-08-08', 'infeccion', 7),
(6, '2024-09-06', 'Timpanización', 7);
...
(1, '2019-12-10', 'Macho', '90', 'ninguno', 3, 4, 3),
...
(8, '2024-08-28', 'Hembra', '20', 'Presenta Anomalías al respirar', 2, 4, 1);
...
(3, '2021-02-15', 'Parasitosis', '6 ml cada 2 dia', 1, 2, 2),
(4, '2024-08-22', 'mastitis', '10mg/kg durante 3 dias', 3, 1, 5),
(5, '2024-08-14', 'Parásitos internos ', '1ml/50kg cada 30 dias', 6, 1, 1),
(6, '2024-08-22', 'Infecciones Bacterianas', '2ml/10kg cada 12 horas', 5, 5, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbreproducción`
--

CREATE TABLE `tbreproducción` (
  `IdReproduccion` int(10) NOT NULL,
  `ReFechadelServicio` date NOT NULL,
  `ReMetododeServicio` varchar(100) NOT NULL,
  `ReResultadodelServicio` varchar(100) NOT NULL,
  `ReFechadeParto` date NOT NULL,
  `ReHoradelParto` time NOT NULL,
  `ReNumerodeNacidos` varchar(20) NOT NULL,
  `ReSexodelNacido` varchar(100) NOT NULL,
  `RePesodelNacido` varchar(100) NOT NULL,
  `ReObservaciones` text NOT NULL,
  `IdRegOvino` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbventa` (
  ...
  `VenIdentificacion` varchar(12) NOT NULL,
...
INSERT INTO `tbventa` (`IdVenta`, `VenFecha`, `VenPrecio`, `VenCantidad`, `VenIdentificacion`, `VenComprador`, `VenCelular`, `IdCategoria`, `IdRaza`) VALUES
(1, '2023-12-12', '300', '1', '', 'Juan Perez', '3226789023', 1, 3),
(2, '2023-12-12', '600', '3', '', 'Marco Rojas', '3122456789', 2, 1),
(3, '2023-12-12', '800', '1', '', 'Armando Mendoza', '3102376459', 3, 2),
(4, '2024-08-30', '285000', '4', '105768903', 'Pedro Rincon', '3212234678', 1, 4),
(5, '2024-09-07', '350000', '3', '1055345678', 'Duvan Perez', '322765489', 2, 1),
(6, '2024-09-05', '150000', '1', '23765489', 'Martha Suarez', '3202678943', 3, 2);
...
--
-- Indices de la tabla `tbreproducción`
--
ALTER TABLE `tbreproducción`
  ADD PRIMARY KEY (`IdReproduccion`);
...
--
ALTER TABLE `tbmedicamentos`
  MODIFY `IdMedicamentos` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `tbmortalidad`
--
ALTER TABLE `tbmortalidad`
  MODIFY `IdMortalidad` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `tbregovino`
--
ALTER TABLE `tbregovino`
  MODIFY `IdRegOvino` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `tbregsalud`
--
ALTER TABLE `tbregsalud`
  MODIFY `IdRegSalud` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de la tabla `tbreproducción`
--
ALTER TABLE `tbreproducción`
  MODIFY `IdReproduccion` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tbventa`
--
ALTER TABLE `tbventa`
  MODIFY `IdVenta` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
